...
def split_routine(video, scenes, split_method, temp, min_scene_len, queue, threshold, ffmpeg_cmd_ext):
        ...
        # Splitting based on aom keyframe placement
            ...
            try:
                ...
                sc = aom_keyframes(video, stat_file, ffmpeg_cmd_ext, min_scene_len)
            except:
